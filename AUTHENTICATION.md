...
- **URL**: `http://localhost/Online-Food-Ordering-System/` or `login.php`
- **Features**:
...
- Phone number field for delivery persons and restaurant managers
...
- **Restaurant Manager**: `public/index.php?route=admin`
- **Delivery Person**: `public/index.php?route=home`
...
### Test Login Flow
1. Visit `http://localhost/Online-Food-Ordering-System/`
...
6. Should create new account and redirect to dashboard
