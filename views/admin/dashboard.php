...
<div class="grid grid-2" style="margin-bottom:24px;">
    ...
    <div class="card"><div class="card-body"><h3>Quick Links</h3><p><a href="../public/index.php?route=admin&action=orders">Review orders</a></p><p><a href="../public/index.php?route=admin&action=users">Manage users</a></p><p><a href="../public/index.php?route=admin&action=products">Manage products</a></p></div></div>
</div>
