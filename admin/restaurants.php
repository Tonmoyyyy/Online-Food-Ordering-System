...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if (isset($_POST['restaurant_id']) && isset($_POST['status'])) {
        ...
        db_execute('UPDATE users SET status = ? WHERE id = ?', 'si', [$status, $rid]);
    }
...
$restaurants = db_fetch_all("SELECT id, name, email, status, created_at FROM users WHERE role = 'restaurant_manager' ORDER BY created_at DESC");
?>
<!DOCTYPE html>
<html lang="en">
<head>
